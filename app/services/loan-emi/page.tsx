...
import { CreditCard, ArrowLeft, Calculator, Shield, Clock } from "lucide-react"
import Link from "next/link"

export default function LoanEMIPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-quaternary/10 via-primary/10 to-secondary/10 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading font-bold text-4xl mb-2 bg-gradient-to-r from-quaternary to-primary bg-clip-text text-transparent">
              Loan EMI Payment
            </h1>
            <p className="text-muted-foreground text-lg">Pay your loan EMIs hassle-free</p>
          </div>
          ...
          <Card className="mb-8 hover-lift border-2 border-quaternary/20 bg-card/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <Button className="w-full bg-gradient-to-r from-quaternary to-primary hover:from-quaternary/90 hover:to-primary/90 text-white font-semibold py-3 animate-pulse-glow">
                Pay EMI
              </Button>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <Card className="text-center p-4 hover-lift bg-gradient-to-br from-primary/10 to-primary/5">
              ...
              <h3 className="font-semibold mb-1">Auto Calculation</h3>
              <p className="text-sm text-muted-foreground">Accurate EMI amounts</p>
            </Card>
